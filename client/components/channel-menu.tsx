                    ...
                    <div className="flex items-center justify-between">
                      <div className="grow flex items-center truncate">
                        <Image
                          ...
                          alt="Channel 01"
                        />
                        <div className="truncate bg-gray-500 bg-red-500 bg-gray-400 text-slate-600 bg-emerald-50 bg-emerald-400 bg-blue-50 bg-blue-400 border-blue-100 border-emerald-100 border-gray-100">
                          #{option.channel}
                        </div>
                      </div>
                      <svg
