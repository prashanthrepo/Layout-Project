                ...
                <div className="w-full sm:w-8/12  flex justify-end gap-2">
                  {/* <form className="relative w-full sm:w-7/12">
                    ...
                    <button
                      ...
                      aria-label="Search">
                      <svg
                        className="w-4 h-4 shrink-0 fill-current text-slate-400 group-hover:text-slate-500 dark:group-hover:text-slate-400 ml-3 mr-2"
                        viewBox="0 0 16 16"
                ...
                <div className="space-y-2 ">
                  {data?.data?.map((layout, key) => (
                    <Link href={`/property?id=${layout?._id}`} key={key}>
                      <div className="shadow-lg rounded-sm border px-5 py-4 bg-white border-slate-200 hover:border hover:border-indigo-500">
