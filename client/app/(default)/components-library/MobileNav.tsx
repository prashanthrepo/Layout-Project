      ...
      <div className="fixed bottom-0 left-0 z-50 w-full h-20 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium pb-2">
          <Link
            ...
            <svg
              className="w-5 h-5 mb-1 text-slate-600 dark:text-slate-600 group-hover:text-indigo-600 dark:group-hover:text-indigo-500"
              aria-hidden="true"
            ...
            <span className="text-sm text-slate-600 dark:text-slate-600 group-hover:text-indigo-600 dark:group-hover:text-indigo-500">
              Home
            </span>
          </Link>
          <Link
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="w-6 h-6 mb-1 text-slate-600 dark:text-slate-600 group-hover:text-indigo-600 dark:group-hover:text-indigo-500">
